...
namespace JDG.Application.Tests.Abilities.Scenarios
{
    ...
    public class EffectAbilityScenarioTests : AbilityScenarioTestBase
    {
        ...
        public void SwapStats_SwapsAtkAndDefForOwnCards()
        {
            ...
            var card1 = CardFactory.CreateInvocation("Card 1", 5, 2, CardFamily.Human);
        ...
        public void SwapStats_TargetOpponent_SwapsOpponentCards()
        {
            ...
            var opponentCard = CardFactory.CreateInvocation("Enemy Card", 6, 2, CardFamily.Monster);
        ...
        public void DivideDefense_HalvesOpponentDef()
        {
            ...
            var opponentCard = CardFactory.CreateInvocation("Tank", 2, 6, CardFamily.Monster);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, opponentCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
        ...
        public void DivideDefense_CanActivate_WhenOpponentHasCards()
        {
            ...
            var opponentCard = CardFactory.CreateInvocation("Card", 2, 4, CardFamily.Human);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, opponentCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
        ...
        public void ControlCard_RequiresUserInput()
        {
            ...
            var myCard = CardFactory.CreateInvocation("My Card", 2, 2, CardFamily.Human);
            ...
            var opponentCard = CardFactory.CreateInvocation("Target", 3, 3, CardFamily.Monster);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, opponentCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
        ...
        public void ControlCard_CanActivate_WhenFieldNotFull()
        {
            ...
            var deck1 = CardFactory.CreateDeck(27);
            deck1.Insert(0, CardFactory.CreateInvocation("Card 1", 2, 2, CardFamily.Human));
            deck1.Insert(1, CardFactory.CreateInvocation("Card 2", 2, 2, CardFamily.Human));
            deck1.Insert(2, CardFactory.CreateInvocation("Card 3", 2, 2, CardFamily.Human));
            var player1 = new Player(PlayerId.Player1, deck1);
        ...
        public void LimitHand_WhenOpponentExceedsLimit_RequiresDiscard()
        {
            ...
            var deck2 = CardFactory.CreateDeck(30);
            var player2 = new Player(PlayerId.Player2, deck2);
        ...
        public void DamageOpponent_ByPlayerInvocationCount_DealsDamagePerCard()
        {
            ...
            var deck1 = CardFactory.CreateDeck(27);
            deck1.Insert(0, CardFactory.CreateInvocation("C1", 2, 2, CardFamily.Human));
            deck1.Insert(1, CardFactory.CreateInvocation("C2", 2, 2, CardFamily.Human));
            deck1.Insert(2, CardFactory.CreateInvocation("C3", 2, 2, CardFamily.Human));
            var player1 = new Player(PlayerId.Player1, deck1);
            player1.DrawCard(); player1.DrawCard(); player1.DrawCard();
            foreach (var c in player1.Hand.ToList()) player1.PlayCard(c);
        ...
        public void SkipAttackPhase_BlocksAllOpponentAttacks()
        {
            ...
            var opponentCard = CardFactory.CreateInvocation("Attacker", 4, 3, CardFamily.Monster);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, opponentCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
        ...
        public void DoubleAttacks_GivesBonusAttacksToAllInvocations()
        {
            ...
            var card1 = CardFactory.CreateInvocation("Fighter 1", 3, 3, CardFamily.Human);
            var card2 = CardFactory.CreateInvocation("Fighter 2", 4, 2, CardFamily.Human);
        ...
        public void DoubleAttacks_CanActivate_WhenInvocationsPresent()
        {
            ...
            var card = CardFactory.CreateInvocation("Fighter", 3, 3, CardFamily.Human);
            var deck = CardFactory.CreateDeck(29);
            deck.Insert(0, card);
        ...
        public void DestroyFieldCard_DestroysOpponentFieldCardForHPCost()
        {
            ...
            var fieldCard = CardFactory.CreateField("Le Hard Corner", CardFamily.HardCorner);
            var deck2 = CardFactory.CreateDeck(29);
        ...
        public void DestroyFieldCard_CanActivate_WhenPlayerHasEnoughHP()
        {
            ...
            var fieldCard = CardFactory.CreateField("Field", CardFamily.Human);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, fieldCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
        ...
        public void EnableDirectAttack_WhenOpponentLowHP_EnablesForAll()
        {
            ...
            var card = CardFactory.CreateInvocation("Attacker", 4, 3, CardFamily.Monster);
            var deck1 = CardFactory.CreateDeck(29);
            deck1.Insert(0, card);
            var player1 = new Player(PlayerId.Player1, deck1);
            player1.DrawCard();
        ...
        public void Effect_DoesNotAffectUnrelatedPlayers()
        {
            ...
            var myCard = CardFactory.CreateInvocation("My Card", 5, 2, CardFamily.Human);
            var deck1 = CardFactory.CreateDeck(29);
            deck1.Insert(0, myCard);
            var player1 = new Player(PlayerId.Player1, deck1);
            player1.DrawCard();
            ...
            var opponentCard = CardFactory.CreateInvocation("Enemy", 3, 4, CardFamily.Monster);
            var deck2 = CardFactory.CreateDeck(29);
            deck2.Insert(0, opponentCard);
            var player2 = new Player(PlayerId.Player2, deck2);
            player2.DrawCard();
