...
public class CardFactory
{
    ...
    public static InGameCard CreateInGameCard(Card card, CardOwner cardOwner, IEventBus eventBus = null, ICardCollectionService cardCollectionService = null)
    {
        return card switch
        {
            ...
            InvocationCard invocationCard => new InGameInvocationCard(invocationCard, cardOwner, eventBus, cardCollectionService),
