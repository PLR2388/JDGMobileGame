...
namespace Lean.Localization
{
    ...
    public class LeanLocalizedDropdown : MonoBehaviour, ILocalizationHandler
    {
        ...
        public class Option
        {
            [LeanTranslationName] public string StringTranslationName;

            [LeanTranslationName] public string SpriteTranslationName;
        ...
        [System.NonSerialized] private HashSet<LeanToken> tokens;
